...
const ROLE_GUIDES: Record<GuideRole, { welcome: string; subtitle: string; steps: GuideStep[] }> = {
  student: {
    ...
    steps: [
      ...
      {
        title: '第三步：查看成长资源',
        desc: '免费观看职业指导外链、公开资源和求职技巧内容，持续提升竞争力。',
        icon: BookOpen,
        color: 'text-amber-600',
        bg: 'bg-amber-50',
        link: '/skill-enhancement',
        linkText: '进入能力提升',
        tips: ['按分类筛选感兴趣的方向', '收藏喜欢的资源方便后续查看'],
      },
      {
        title: '第四步：收藏 & 追踪',
        desc: '收藏感兴趣的职位和成长内容，在消息中心接收投递反馈通知。',
        icon: Heart,
        color: 'text-rose-600',
        bg: 'bg-rose-50',
  ...
  mentor: {
    ...
    steps: [
      {
        title: '第一步：完善导师资料',
        desc: '填写个人简介、擅长领域、辅导价格和可服务时间段，提交资质审核。',
        icon: User,
        color: 'text-emerald-600',
        bg: 'bg-emerald-50',
        link: '/mentor/profile',
        linkText: '去完善资料',
        tips: ['详细描述你的从业经历和擅长领域', '设置合理的辅导价格', '提供多个可服务时间段增加曝光'],
      },
      {
        title: '第二步：上传公开资源',
        desc: '上传公开资源内容，沉淀你的行业经验、求职技巧和可复用资料。',
        icon: Video,
        color: 'text-blue-600',
        bg: 'bg-blue-50',
        link: '/mentor/courses',
        linkText: '去上传资源',
        tips: ['选择合适的资源分类', '添加精准标签方便学生搜索', '公开资源能帮助你持续积累口碑'],
      },
      {
        title: '第三步：管理咨询学员',
        desc: '查看和确认已进入服务流程的咨询学员，安排沟通与履约时间。',
        icon: Calendar,
        color: 'text-amber-600',
        bg: 'bg-amber-50',
        link: '/mentor/appointments',
        linkText: '查看咨询管理',
        tips: ['及时确认服务安排避免学员等待', '沟通前先了解学员的具体需求', '服务结束后沉淀反馈与记录'],
      },
      {
        title: '第四步：查看评价 & 数据',
  ...
  admin: {
    ...
    steps: [
      ...
      {
        title: '内容审核',
        desc: '管理平台上的职位和资源内容，确保信息合规、真实有效。',
        icon: Video,
        color: 'text-green-600',
        bg: 'bg-green-50',
        link: '/admin/content',
        linkText: '管理内容',
        tips: ['定期清理过期的职位信息', '审核资源内容是否符合平台规范'],
